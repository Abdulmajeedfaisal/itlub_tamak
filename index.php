...
<head>
    ...
    <link rel="icon" href="#">
    <title>الصفحة الرئيسية || نظام طلب الطعام عبر الانترنت </title>
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span> اختيار مطعم</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span> طلب طعام</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>توصيل الطلبية</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>أطباق شهرية مشهورة</h2>
                <p class="lead">أسهل طريقة لطلب طعامك المفضل من بين هذه الأطباق الستة الأكثر شهرة</p>
            </div>
            <div class="row">
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">$' . $r['price'] . '</span> <a href="dishes.php?res_id=' . $r['rs_id'] . '" class="btn theme-btn-dash pull-right">إطلب الان</a> </div>
                                                </div>
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>اختر مطعمك<h3>
                                        <p>"لدينا كل ما تحتاجه من قوائم الطعام للعديد من المطاعم التي تقدم خدمة التوصيل عبر الإنترنت."</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>"اختر وجبة"</h3>
                            <p>"لدينا مجموعة متنوعة من المطاعم المتاحة للتوصيل عبر الإنترنت".</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>"احصل على توصيل طعامك! واستمتع بوجبتك" </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">"الدفع عند الاستلام"</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-sm-8">
                    <div class="restaurants-filter pull-right">
                        <nav class="primary pull-left">
                            <ul>
                                <li><a href="#" class="selected" data-filter="*">كل</a> </li>
                                <?php
