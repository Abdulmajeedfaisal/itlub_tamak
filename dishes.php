        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">اختر المطعم</a></li>
            ...
            <div class="row">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                ?>
                                    ...
                                    <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn btn-danger btn-lg disabled">الدفع</a>

                                <?php
                                } else {
                                ?>
                                    <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn btn-success btn-lg active">الدفع</a>
                                <?php
                                }
                                ?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                قائمة الطعام <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                    ...
                                    <div class="food-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                                ...
                                                <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="إضافة إلى السلة" />
                                            </div>
                                            </form>
                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn theme-btn">اضافة الى السلة</button>
                </div>
            </div>
        </div>
    </div>
